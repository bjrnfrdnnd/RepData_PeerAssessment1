...
```{R chunk-Histogram-ignoring-missing-data, results="hide", warning=FALSE, message=FALSE}
require(ggplot2)
require(dplyr)
df <- df_orig %>% na.omit()
...
```{R chunk-mean-median-ignoring-missing-data, echo=TRUE, results="asis", message=FALSE, warning=FALSE}
require(knitr)
require(kable)
require(kableExtra)
...
```{R chunk-activity-patern-ignoring-missing-data, results="hide", warning=FALSE, message=FALSE}
require(ggplot2)
require(dplyr)
require(lubridate)
# remove NA values
...
```{R chunk-max-steps-interval, results="asis", warning=FALSE, message=FALSE}
require(ggplot2)
require(dplyr)
require(lubridate)
require(kable)
...
```{R chhunk-missing-data-pre-analysis,  message=FALSE,warning=FALSE}
df <- df_orig;
...
```{R chunk-missing-data-length-analysis, results="asis", warning=FALSE, message=FALSE}
require(kable)
require(kableExtra)
...
```{R chunk-missing-data-imputation-strategy, results="asis", warning=FALSE, message=FALSE}
require(tidyr)
require(dplyr)
require(imputeTS)
...
```{R chunk-histogram-with-imputed-data, results="hide", warning=FALSE, message=FALSE}
require(ggplot2)
require(dplyr)
df <- dfWithImputation;
df_steps_per_day <- df %>% group_by(date) %>%
...
```{R chunk-histogram-with-split-imputed-data,  message=FALSE,warning=FALSE}
require(ggplot2)
require(dplyr)
...
```{R chunk-effect-of-imputation-on-mean-and-median, results="asis", warning=FALSE, message=FALSE}
require(dplyr)
require(kable)
require(kableExtra)
...
```{R chunk-daytype-analysis, results="asis", message=FALSE,warning=FALSE}
require(ggplot2)
require(dplyr)
require(lubridate)
require(kable)
